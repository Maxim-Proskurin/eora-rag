...
collection_name = "eora_gigachat"

faq_answers = {}
for q in FAQ_QUESTIONS:
    print(f"Генерирую ответ для: {q}")
    answer = generate_answer_gigachat(q, collection_name=collection_name)
    faq_answers[q] = answer

with open("faq_answers_gigachat.json", "w", encoding="utf-8") as f:
    json.dump(faq_answers, f, ensure_ascii=False, indent=2)
print("FAQ-ответы для GigaChat сохранены в faq_answers_gigachat.json")